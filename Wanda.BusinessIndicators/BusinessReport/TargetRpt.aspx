<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage/MonthReportMasterPage.Master" AutoEventWireup="true" CodeBehind="TargetRpt.aspx.cs" Inherits="Wanda.BusinessIndicators.Web.BusinessReport.TargetRpt" %>
...
<%--                    <li id="BHhide2"><a class="active_sub2" onclick="ChangeTargetDetail(this,'Tab');"><span>指标完成情况明细</span></a></li>
            ...
            <div class="tabs_content">
                ...
                <!--完成情况明细 start-->
                <div class="TClassHide" id="T6">
                    <ul class="tabs" style="border-bottom-color: #FFF; margin-top: 5px; height: auto; margin-bottom: 0px;">
                    </ul>
                    <table class="tab_005" id="Table2" style="width: 100%;">
                        <thead id="DSCompleteDetailHead">
                        </thead>
                        <tbody id="DStab2_rows">
                        </tbody>
                    </table>
                </div>
                <!--完成情况明细 end-->
                ...
                <!--补回一季度经营指标缺口情况 开始-->
                <div id="T7" class="TClassHide">
                    <ul class="tabs" style="border-bottom-color: #FFF; margin-top: 5px; height: auto; margin-bottom: 0px;">
                    </ul>
                    <table class="tab_005" id="Table3" style="table-layout: fixed; margin-top: 5px;">
                        <thead id="DSReturn_Thead">
                        </thead>
                        <tbody id="DSTbody_Data">
                        </tbody>
                    </table>
                </div>
                <!--补回一季度经营指标缺口情况 结束-->
                ...
                <div id="T9" class="TClassHide">
                    ...
                    <table class="tab_005" style="table-layout: fixed; margin-top: 5px;">
                        ...
                        <tbody id="Action_Row" class="tab_001">
                        </tbody>
                    </table>
                </div>
                <!--上报日志 结束-->
