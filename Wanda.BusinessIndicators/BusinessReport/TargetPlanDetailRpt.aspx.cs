...
{
    public partial class TargetPlanDetailRpt : System.Web.UI.Page
    {
        ...
        public void TransferOtherPage(Guid SystemID)
        {
            ...
            {
                Response.Redirect("../SystemConfiguration/TargetCollectDisplay.aspx?SystemID=" + HttpUtility.UrlEncode(SystemID.ToString()));
            }
