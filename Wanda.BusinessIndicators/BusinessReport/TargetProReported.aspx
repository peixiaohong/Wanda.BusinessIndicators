<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage/MainMasterPage.Master" AutoEventWireup="true" CodeBehind="TargetProReported.aspx.cs" Inherits="Wanda.BusinessIndicators.Web.BusinessReport.TargetProReported" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 <link href="http://zbgk.wf.wanda-dev.cn/RuntimeService/css/wanda-wf-client.css?version=1" type="text/css" rel="Stylesheet" />
    ...
    <script type="text/javascript" src="../Scripts/BusinessReport/TargetProReported.js"></script>
    <script type="text/javascript" src="../Scripts/BusinessReport/TargetProReported1.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="main">
        ...
        <div class="TClassHide" id="T2">
                <table class="tab_005" id="importedDataTable2" style="margin-top:43px;" >
        ...
        <!--保存展示list 开始-->
          ...
          <div  id="T5">
               ...
               <MonthLyReportActionUC:MonthReportedAction ID="MonthReportedAction1" runat="server" />
            <%--  <table class="tab_005" id="Tab_SaveReady">
                <thead  id="Tab_SaveReadyHead">      
                </thead>
                <tbody id="Tab_SaveReadyData">
                </tbody>
            </table>--%>
   ...
   <div id="divMonthReportDetail" class="popup" style="height: auto; display: none; padding-bottom: 10px">
    ...
    <input type="hidden" style="width:100%"  id="wanda_wf_hd_process" value="" />
    <input type="hidden" style="width:100%"  id="wanda_wf_opInfo" value="" />
</asp:Content>
