<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage/MonthReportMasterPage.Master" AutoEventWireup="true" CodeBehind="ChildrenCompanyRpt.aspx.cs" Inherits="Wanda.BusinessIndicators.Web.BusinessReport.ChildrenCompanyRpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="main">
        ...
        <div class="content_m" style="overflow:hidden">
            ...
            <div class="DownExcelDiv" id="DownChildren" style="width:200px;float:left;">
                <span class="DownExcelspan">
                    <div class="uploadify-button" id="file_upload-button1" onclick="DownExcelReport('Children');" style="margin-bottom:5px;position:relative;top:-5px;">
                        <span>
                            <label class="DownExcelLabel" id="LabelDownload">导出宝贝王固定报表</label>
