...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main">
        ...
        <div class="content_m" style="overflow: hidden">
            ...
            <div class="DownExcelDiv" id="DownCulture" style="width: 200px; float: left;">
                <span class="DownExcelspan">
                    <div class="uploadify-button" id="file_upload-button1" onclick="DownExcelReport('Culture');" style="margin-bottom: 5px; position: relative; top: -5px;">
                        <span>
                            <label class="DownExcelLabel" id="LabelDownload">导出文化集团整体固定报表</label>
