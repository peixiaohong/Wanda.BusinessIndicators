...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" src="../Scripts/jquery.tmpl.js?ver=<%=new Random(DateTime.Now.Millisecond).Next(0,10000)%>"></script>
    <script type="text/javascript" src="../Scripts/BusinessReport/ProTargetApprove.js?ver=<%=new Random(DateTime.Now.Millisecond).Next(0,10000)%>"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="main">
        ...
        <asp:HiddenField runat="server" ID="HiddBusinessID" ClientIDMode="Static" />
        <asp:HiddenField runat="server" ID="hideSystemID" ClientIDMode="Static" />
        <asp:HiddenField runat="server" ID="HiddenMonth" ClientIDMode="Static" />
