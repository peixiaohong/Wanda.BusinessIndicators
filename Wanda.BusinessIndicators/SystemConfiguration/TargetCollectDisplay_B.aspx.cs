...
{
    public partial class TargetCollectDisplay_B : System.Web.UI.Page
    {
        ...
        public void TransferOtherPage(Guid SystemID)
        {
            ...
            {
                Response.Redirect("../BusinessReport/TargetPlanDetailRpt_B.aspx?SystemID=" + HttpUtility.UrlEncode(SystemID.ToString()));
            }
