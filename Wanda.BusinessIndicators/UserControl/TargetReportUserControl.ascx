<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TargetReportUserControl.ascx.cs" Inherits="Wanda.BusinessIndicators.Web.UserControl.TargetReportUserControl" %>
