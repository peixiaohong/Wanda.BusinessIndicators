...
(function($) {
	...
	var LG = 'linear-gradient(top, #fafafa, #eee)', CSS = '<style type="text/css">' +
		...
		'.wrap_bar{border-bottom:1px solid #ddd;color:#fff;background:#f0f0f0 url(../images2/popup_box_title.png);background:-moz-' + LG + ';background:-o-' + LG + ';background:-webkit-' + LG + ';background:' + LG + ';}' +
