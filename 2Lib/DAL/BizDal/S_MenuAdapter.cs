    ...
    sealed class S_MenuAdapter : AppBaseAdapterT<S_Menu>
    {
        ...
        public List<S_Menu> GetRoleMenus(Guid ID)
        {
            string sql = @"Select A.*,
                           ...
                           Left Join [dbo].[S_RolePermissions] As B On A.[ID]=B.[MenuID] And B.[IsDeleted]=0 And B.[RoleID]=@RoleID
                           Where A.[IsDeleted]=0 
            ...
            DataTable dt = ExecuteReturnTable(sql, parameters);
        ...
        public List<S_Menu> GetLoinNameMenu(string loginName)
        {
            string sql = @"With menu_TempData
                           ...
                           Where A.[IsDeleted]=0  And A.[LoginName]=@LoginName
                           Union All
                           ...
                           Select Distinct * From menu_TempData Order By [Sequence] Asc";
            DbParameter[] parameters = new DbParameter[]
            {
