...
function operateNav(sender) {
    ...
    switch (sender) {
        ...
        case "monthReportSubmit":
            $("#process").show();
            $.blockUI({ message: "<div style='width:200px'><img src='TargetProReported_files/ajax-loader.gif' alt='waiting'><span style='font-size:20px;padding-left:20px;color:#3f3f3f'>数据请求中...</span></div>" });
