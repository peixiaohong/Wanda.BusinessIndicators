...
function DownExcelReport(sender) {
    ...
    window.open("/AjaxHander/DownExcelTargetPlan.ashx?FileType=Reported&SystemID=" + $("#ddlSystem").attr("value") + "&TargetPlanID=&FinYear=" + $("#ddlYear").attr("value") + "&IsLatestVersion=" + latest + "&IsReported=true");
}
