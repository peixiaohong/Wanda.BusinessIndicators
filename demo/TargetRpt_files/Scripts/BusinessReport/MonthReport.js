...
//加载动画开始
function Load() {
    $.blockUI({ message: "<div style='width:200px'><img src='TargetRpt_files/images/ajax-loader.gif' alt='waiting'><span style='font-size:20px;padding-left:20px;color:#3f3f3f'>数据请求中...</span></div>" });
}
//加载动画结束
function Fake() {
    $.unblockUI();
...
function ChangeTargetDetail(sender, TabOrSearch) {
    ...
    if ($(sender).text() == "月度经营报告" || TabOrSearch == "Search") {
        ...
        //window.location.href = "../ProMonthReport1.htm";
        ...
        $("#T9").show();
        $("#T1,#T2,#T3,#T3_1,#T5,#MonthReportExplainDiv,#ApproveAttachDiv,#T4,#T6,#T7,#T8,#DownExcel").hide();
        ...
        $("#T5,#DownExcel").show();
        $("#T1,#T2,#T3,#T3_1,#MonthReportExplainDiv,#ApproveAttachDiv,#T4,#T6,#T7,#T8,#T9").hide();
        ...
        $("#T7,#DownExcel").show();
        $("#T1,#T2,#T3,#T3_1,#MonthReportExplainDiv,#ApproveAttachDiv,#T4,#T5,#T6,#T8,#T9").hide();
        var obj = $("#DSReturn_Thead");
        var tab = $("#DSTbody_Data");
    } else if ($(sender).text() == "新增未完成门店情况" || TabOrSearch == "Search") {
        $("#T8,#DownExcel").show();
        $("#T1,#T2,#T3,#T3_1,#MonthReportExplainDiv,#ApproveAttachDiv,#T4,#T5,#T6,#T7,#T9").hide();
        var obj = $("#DSAdd_Thead");
    ...
    if ($(sender).text() != "完成情况明细") {
        ...
        $('#imgtableUpDown').attr("src", "TargetRpt_files/images/images1/Down.png");
    } else {
        $('#imgtableUpDown').show();
    }
}
...
function UpDownTableClick() {
    if ($('#imgtableUpDown').attr("src") == "TargetRpt_files/images/images1/Down.png") {
        $('#imgtableUpDown').attr("src", "TargetRpt_files/images/images1/Up.png");
...
function ComplateDetailLiaddCss(sender) {
    ...
    else if ($(sender).attr("data-value") == "经营报告明细-回款") {
        $("#importedDataTable1").hide();
        $("#importedDataTable2").show();
        $("#importedDataTable3").hide();
    }
    else if ($(sender).attr("data-value") == "经营报告明细-利润额") {
        $("#importedDataTable1").hide();
        $("#importedDataTable2").hide();
        $("#importedDataTable3").show();
    }
...
function SetComplateTargetDetailData(sender, Type) {
    ...
    if (MonthReportOrderType == "Detail") {
        $(".DetailMonthly").attr("src", "TargetRpt_files/images/btn_down02_w.png");
        $(".Detail").attr("src", "TargetRpt_files/images/btn_down03_w.png");
        $(".DetailMonthlyCss").addClass("tabOrderBackground");
    } else {
        $(".DetailMonthly").attr("src", "TargetRpt_files/images/btn_down03_w.png");
        $(".Detail").attr("src", "TargetRpt_files/images/btn_down02_w.png");
...
function ClickCounter2(sender) {
    if ($(sender).hasClass("DetailShow") == true) {
        $(sender).removeClass("DetailShow").addClass("Detailminus");
        $(sender).nextUntil(".item3").each(function () {
            $(this).show();
        });
    }
    else {
                        ...
                        $(this.ReturnDataList).each(function (i) {
                            ...
                            if (i == 0) {
                                ...
                                if (this.Counter == 0) {
                                    ...
                                    strTrueTbody += "<td class=\"Td_Left\"><img src=\"TargetRpt_files/images/images1/image" + this.Counter + ".png\" /></td>";
                                }
                                strTrueTbody += "</tr>";
                            }
                            else {
                        ...
                        $(this.ReturnDataList).each(function (i) {
                            if (i == 0) {
                                ...
                                if (this.Counter == 0) {
                                    ...
                                    strFalseTbody += "<td class=\"Td_Left\"><img src=\"TargetRpt_files/images/images1/image" + this.Counter + ".png\" /></td>";
                                }
                                strFalseTbody += "</tr>";
                            }
                            else {
                                ...
                                $(this.ReturnDataList).each(function (i) {
                                    if (i == 0) {
                                        ...
                                        if (this.Counter == 0) {
                                            ...
                                            strTbody += "<td class=\"Td_Left\"><img src=\"TargetRpt_files/images/images1/image" + this.Counter + ".png\" /></td>";
                                        }
                                        strTbody += "</tr>";
                                    }
                                    else {
