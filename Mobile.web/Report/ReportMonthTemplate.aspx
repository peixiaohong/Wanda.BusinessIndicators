            ...
            <div class="page-body" style="margin: 0">
                <div class="collection-cont col-md-12 col-sm-12">
                    <ul style="padding-top: 0; border-top: 0 solid;">
                        ...
                        <li class="active">
                            <h3 v-bind:class="{'bottom': yearlyState}">{{result.Name}}(全年 单位:万元)<span v-bind:class="{'collection-updown-icon': true, 'collection-down-icon': yearlyState}" v-on:click="yearlyState = !yearlyState"></span></h3>
                                                            ...
                                                            <tr>
                                                                <th style="padding: 0; width: 33.8%">
                                                                    <table>
                                                                        <tr>
                                                                            <td style="width: 20%">{{index + 1}}</td>
                                                                            <td style="width: 80%" v-on:click="items.IsYearShow = !items.IsYearShow">{{items.CompanyName}}</td>
                                                                        </tr>
                                                                    </table>
                                                                </th>
                                                                <td style="width: 22.1%">{{Vue.ToThousands(items.NPlanAmmount)}}</td>
